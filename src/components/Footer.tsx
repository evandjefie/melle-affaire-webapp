    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-playfair font-bold mb-4 text-gold">MELLE Affaire</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-gold transition-colors" aria-label="TikTok">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-4">{t('products.title')}</h3>
        ...
        <div className="pt-8 border-t border-gray-800 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© {currentYear} MELLE Affaire. {t('footer.rights')}.</p>
